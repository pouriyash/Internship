        ...
        )
        {
            ...
            return $@"
                ...
                >
                    ...
                    <select name='{name}' {(initSelect2 ? " data-role='select2' " : "")} {(required ? " required='required' " : "")} placeholder='{placeholder}' style='display: none;' class='form-control'{(disabled == true ? "disabled" : "")}></select>
                </div>
            ";
        }
                    ...
                    $(function () {
                        ...
                        function fillDropdown(name) {
                            ...
                            request.then(function (response) {
                                ...
                                var $optionPlaceholder = $('<option></option>')
                                    .attr('value', '')
