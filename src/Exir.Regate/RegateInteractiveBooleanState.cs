...
namespace Exir.Regate
{
    public static class RegateInteractiveBooleanState
    {
        public static string Build(int id
            , bool? value
            , string url
            , string iconTrue = "circle"
            , string iconFalse = "circle"
        ...
        )
        {
            ...
            var html = $@"
                <div style='white-space: nowrap; display: inline-block' id='{uniqueId}' v-cloak>
                    <span id='{uniqueId}state__null' class='{nullColor}' style='display: none; cursor: pointer; color: {colorNull}' title='{(string.IsNullOrWhiteSpace(titleNull) ? title : titleNull)}'>
                        <i class='fa fa-{iconNull} {className}'></i>
                    </span>

                    <span id='{uniqueId}state__0' class='{falseColor}' style='display: none; cursor: pointer; color: {colorFalse}' title='{(string.IsNullOrWhiteSpace(titleFalse) ? title : titleFalse)}'>
                        <i class='fa fa-{iconFalse} {className}'></i>
                    </span>

                    <span id='{uniqueId}state__1' class='{trueColor}' style='display: none; cursor: pointer; color: {colorTrue}' title='{(string.IsNullOrWhiteSpace(titleTrue) ? title : titleTrue)}'>
